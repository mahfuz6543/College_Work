...
namespace main_savitch_4
{
    ...
    private:
        ...
        size_type used;         // size_type variable to keep track of the current length of the sequence
        size_type current_index;// index to the current item
        size_type capacity;     // size_type variable to keep track of the complete capacity of the dynamic array
    };
