...
import { useLogin } from "../../rest/hooks/user";
...
function Login({setUser}) {
    ...
    const { mutate: login, isSuccess, isLoading, data } = useLogin();
                                ...
                                <div className="col-12 my-5 mx-auto">
                                    ...
                                    <div className="row justify-content-center my-2">
                                        ...
                                        <a href={APP_ROUTES.register}>
                                            <small className="text-muted">You don't have an accout? Register</small>
                                        </a>
                                    </div>
                                </div>
                            </form>
